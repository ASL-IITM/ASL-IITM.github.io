...
{% include research-card.html
   title="Exoskeleton Glove for Rehabilitation"
   image="/images/exo/exo.png"
   alt="Exoskeleton glove mechanism for finger rehabilitation"
   url="/exoglove/"
   description="Designing a 2 DOF mechanism that mimics human finger motion, extended into a full glove with series elastic actuation for assisting and rehabilitating brachial plexus patients."
   funding="Funded by the New Faculty Initiation Grant (NFIG) from IIT Madras."
%}
