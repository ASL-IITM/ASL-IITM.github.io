...
<ol>
<li> Kunwar, V., Sai, TS., Sebastian, B., "Hierarchical approach towards cooperative manipulation and transportation using mobile robots", Journal of Mechanisms and Robotics, Transactions of the ASME, <a href="https://doi.org/10.1115/1.4070892"> {{ "DOI: 10.1115/1.4070892" | escape }}</a> </li>
