...
{% include research-card.html title="Intelligent Grasping and Manipulation" image="/images/disassembly/ur5.jpg" alt="UR5 robot arm performing grasping task" url="/intelligent_grasping/" description="Perception, motion planning, and control for autonomous grasping in real-world and human-robot collaborative workspaces." funding="Funded by Accenture – IIT Madras Centre of Excellence." %}

{% include research-card.html title="Motion Planning for Mobile Robots" image="/images/mobile_robot/mobile_vision.jpg" alt="Indoor autonomous mobile robot with vision sensors" url="/mobile_robot/" description="Autonomous navigation for mobile robots in indoor and outdoor environments, including GPS-denied localization and human-aware planning." funding="Funded by NFIG, IIT Madras." %}

{% include research-card.html title="Multi-Agent Systems" image="/images/mobile_manipulation/mobile_manipulation.jpg" alt="Multi-robot cooperative manipulation system" url="/multi_agent_systems/" description="Cooperative manipulation and transportation using multiple mobile robots coordinated through decentralized planning." funding="Funded by SRG, SERB." %}

{% include research-card.html title="Autonomous Driving and ADAS" image="/images/auto_drive/vehicle_suite.png" alt="Autonomous vehicle sensor suite" url="/auto_drive/" description="Autonomous driving and ADAS for Indian road conditions, including perception, planning, and control for electric vehicles." funding="Funded by NFSG, IIT Madras." %}
